 ...
 */
final class Version20250522052501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ...
            , slug VARCHAR(255) NOT NULL, excerpt CLOB DEFAULT NULL, is_published BOOLEAN DEFAULT NULL, CONSTRAINT FK_23A0E66F675F31B FOREIGN KEY (author_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_23A0E6612469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO article (id, author_id, category_id, title, content, image_url, published_at, created_at, updated_at, slug, excerpt) SELECT id, author_id, category_id, title, content, image_url, published_at, created_at, updated_at, slug, excerpt FROM __temp__article
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO audio (id, author_id, category_id, title, description, audio_url, cover, duration, published_at, created_at, updated_at, slug) SELECT id, author_id, category_id, title, description, audio_url, cover, duration, published_at, created_at, updated_at, slug FROM __temp__audio
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, category_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, content CLOB DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, published_at DATETIME DEFAULT NULL (DC2Type:datetime_immutable)
            , created_at DATETIME NOT NULL (DC2Type:datetime_immutable), updated_at DATETIME DEFAULT NULL (DC2Type:datetime_immutable)
